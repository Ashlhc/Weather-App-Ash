...
function getLatandLon(cityName){
    var requestLatURL = 'https://api.openweathermap.org/geo/1.0/direct?q='+cityName+',US&limit=1&appid=8d95eef109d423165de3e03e02d4d24d';
    fetch(requestLatURL)
    ...
    .then(function(data){
        ...
        var forecastRequest = 'https://api.openweathermap.org/data/2.5/forecast?lat='+latCity+'&lon='+lonCity+'&units=imperial&appid=8d95eef109d423165de3e03e02d4d24d';
        var currentWeather ='https://api.openweathermap.org/data/2.5/weather?lat='+latCity+'&lon='+lonCity+'&units=imperial&appid=8d95eef109d423165de3e03e02d4d24d';
